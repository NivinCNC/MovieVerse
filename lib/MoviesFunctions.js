...
export const getTrendingMovies = async (type = "all", page = 1) => {
  const url = `https://api.themoviedb.org/3/trending/${(type === "movies" ? "movie" : type) || "all"}/day?language=en-US&page=${page}&api_key=56c3457c0ec5b0ce159e30509789e213`;
...
export const getPopularMovies = async (page) => {
  const url = `https://api.themoviedb.org/3/movie/popular?language=en-US&page=${page}&api_key=56c3457c0ec5b0ce159e30509789e213`;
...
export const getTopRatedMovies = async () => {
  const url = `https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=1&api_key=56c3457c0ec5b0ce159e30509789e213`;
...
export const getInfoTMDB = async (TMDBID, media_type) => {
  ...
  const url = media_type === "movie"
    ? `${baseUrl}/movie/${TMDBID}?language=en-US&api_key=56c3457c0ec5b0ce159e30509789e213&append_to_response=external_ids`
    : `${baseUrl}/tv/${TMDBID}?language=en-US&api_key=56c3457c0ec5b0ce159e30509789e213&append_to_response=external_ids`;
...
export const getRecommendation = async (TMDBID, Type) => {
  const url = `https://api.themoviedb.org/3/${Type || "movie"}/${TMDBID}/recommendations?&api_key=56c3457c0ec5b0ce159e30509789e213`;
